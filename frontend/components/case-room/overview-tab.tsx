...
const mockTimeline: TimelineEvent[] = [
  { id: "te-001", eventType: "milestone", title: "FIR Filed", eventDate: "2024-10-15", description: "FIR No. 847/2024 filed at Saket PS", status: "completed", autoGenerated: false, createdAt: "2024-10-15" },
  { id: "te-002", eventType: "milestone", title: "Arrest", eventDate: "2024-10-16", description: "Accused arrested and produced before CMM", status: "completed", autoGenerated: false, createdAt: "2024-10-16" },
  { id: "te-003", eventType: "hearing", title: "Bail Hearing", eventDate: "2024-10-30", description: "Bail granted by Sessions Court", status: "completed", autoGenerated: false, createdAt: "2024-10-30" },
  { id: "te-004", eventType: "filing", title: "Charge Sheet Filed", eventDate: "2025-01-18", description: "Charge sheet filed under Sections 302, 120B IPC", status: "completed", autoGenerated: false, createdAt: "2025-01-18" },
  { id: "te-005", eventType: "milestone", title: "Charges Framed", eventDate: "2025-06-15", description: "Charges framed, accused pleaded not guilty", status: "completed", autoGenerated: false, createdAt: "2025-06-15" },
  { id: "te-006", eventType: "hearing", title: "Evidence Stage", eventDate: "2026-03-15", description: "Prosecution evidence — next witness examination", status: "current", autoGenerated: false, createdAt: "2026-03-15" },
  { id: "te-007", eventType: "hearing", title: "Arguments", eventDate: "2026-06-01", description: "Final arguments expected", status: "upcoming", autoGenerated: false, createdAt: "2026-06-01" },
];
